...
// Sub-byte integer vector carried through a cf.br block-arg. The cf branch
// pattern registered by vector::populateVectorNarrowTypeEmulationCFPatterns
// (wrapping cf::populateCFStructuralTypeConversionsAndLegality) rewrites
// both the cf.br operand type and the successor block-arg type using the
// arith narrow-type vector converter.
