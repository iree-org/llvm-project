...
func.func @push_through_generic_rank0_operand(%arg0: tensor<128x128xf32>, %arg1: tensor<?x?xbf16>, %arg2: index, %arg3 : f32) -> tensor<?x?xbf16> {
  %extracted_slice = tensor.extract_slice %arg0[%arg2, %arg2] [%arg2, %arg2] [1, 1] : tensor<128x128xf32> to tensor<?x?xf32>
...
// CHECK-LABEL: func.func @push_through_generic_rank0_operand
// CHECK:         %[[GENERIC:.+]] = linalg.generic
