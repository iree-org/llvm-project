...
void vector::populateVectorNarrowTypeEmulationPatterns(
  ...
  // When assumeAligned is set, store offsets are assumed to be aligned to
  // container element boundaries, so isDivisibleInSize alone is sufficient
  // for the aligned path and no RMW sequences are generated.
