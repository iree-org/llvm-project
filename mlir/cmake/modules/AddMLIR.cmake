...
function(add_mlir_library name)
  ...
  if(ARG_ENABLE_AGGREGATION)
    ...
    elseif(WIN32)
      # Windows has issues with object libraries (path corruption in response files).
      # Use /WHOLEARCHIVE instead of -force_load for MSVC.
      list(APPEND AGGREGATE_DEPS "/WHOLEARCHIVE:${name}")
